...
Truck::Truck(const Vector2& pcenter)
{
    ...
    trailer = new Rectangle(Vector2(center_.x() - TRAILER_WIDTH / 2, center_.y()),
    ...
    window = new Rectangle(Vector2(cabin->center().x(), cabin->center().y() - WINDOW_HEIGHT / 2),
                        WINDOW_COLOR, WINDOW_WIDTH, WINDOW_HEIGHT);
    engine = new Rectangle(Vector2(cabin->center().x() + CABIN_WIDTH / 2 + ENGINE_WIDTH / 2,
