...
TEST_CASE("LP::testRemoveEASY", "[weight=6]")
{
...
TEST_CASE("LP::testRemoveHard", "[weight=10]")
{
...
TEST_CASE("LP::testResizeOnce", "[weight=7]" )
{
...
TEST_CASE("LP::testResizeAll", "[weight=11]")
{
...
TEST_CASE("LP::testInsertEasy", "[weight=6]")
{
	TextFile infile( "tests/textEasy.txt" );
	LPHashTable<string, int> hashTable(32);
	int val = 0;
...
TEST_CASE("LP::testInsertHard", "[weight=10]")
{
	TextFile infile( "tests/textHard.txt" );
	LPHashTable<string, int> hashTable(32);
    int val = 0;
