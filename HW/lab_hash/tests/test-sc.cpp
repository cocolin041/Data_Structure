...
TEST_CASE("SC::testRemoveEASY", "[weight=6]")
{
...
TEST_CASE("SC::testRemoveHard", "[weight=10]")
{
...
TEST_CASE("SC::testResizeOnce", "[weight=7]" )
{
...
TEST_CASE("SC::testResizeAll", "[weight=11]")
{
...
TEST_CASE("SC::testInsertEasy", "[weight=6]")
{
	TextFile infile( "tests/textEasy.txt" );
	SCHashTable<string, int> hashTable(32);
	int val = 0;
...
TEST_CASE("SC::testInsertHard", "[weight=10]")
{
	TextFile infile( "tests/textHard.txt" );
	SCHashTable<string, int> hashTable(32);
    int val = 0;
