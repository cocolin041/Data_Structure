...
int main() {
  ...
  // List 1: 0 2 2 2
  p00.data_ = 1; p00.next_ = &p01;
  p01.data_ = 1; p01.next_ = &p02;
  p02.data_ = 2; p02.next_ = NULL;
  // p02.data_ = 2; p02.next_ = &p03;
  // p03.data_ = 2; p03.next_ = NULL;

  // List 2: 0 0 0 4
  p10.data_ = 1; p10.next_ = &p11;
  p11.data_ = 1; p11.next_ = &p12;
  p12.data_ = 2; p12.next_ = &p13;
  p13.data_ = 2; p13.next_ = NULL;
