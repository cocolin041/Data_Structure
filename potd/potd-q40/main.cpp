...
int main() {
    ...
    Student a = Student(6, "LAB");
    Student b = Student(13, "POTD");
    Student c = Student(6, "LAB");
    Student d = Student(13, "POTD");
    ...
    officeHourQueue.push(a);
    officeHourQueue.push(b);
    officeHourQueue.push(c);
    officeHourQueue.push(d);

    Staffer Wade = Staffer("LAB", 12);
    Staffer Mattox = Staffer("MP", 10);
    Staffer hello = Staffer("MP", 10);
    vector<Staffer> onDutyStaff {Wade, Mattox};

    int expectedWaitTime = waitTime(officeHourQueue, onDutyStaff, 7);
